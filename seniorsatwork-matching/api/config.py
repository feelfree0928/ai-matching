...
def get_max_raw_score(weights: dict[str, float] | None = None) -> float:
    ...
    Experience max = exp_primary(2.0) + exp_secondary(0.6) = 2.6 (expTotal removed: double-counted sec years).
    Category is now a hard filter, not a scored dimension.
    """
